...
widget in React and TypeScript with guidance of Figma UX design and the Appfolio’s Coastline UI package.`,
  ...
  },
  {
    ...
    links: {}, // add repo or demo links here if they become available
    description:
      'Designed and delivered an optical-recognition module that lets the Z3-Mini AUV autonomously locate and dock on underwater parking bases with 85 % accuracy in turbid, bio-fouled lakes.',
    details: [
      'Trained a TensorFlow CNN to detect parking-base contours and offsets, achieving 85 % mean accuracy across muddy-water test sets.',
      'Implemented defogging, margin detection, and ellipse-fitting pipelines in Python/C++ (OpenCV) to enhance low-contrast images and extract reliable geometric cues.',
      'Optimized inference latency to meet real-time AUV constraints and verified robustness on bases obscured by aquatic growth and suspended sediment.',
    ],
  },
  {
